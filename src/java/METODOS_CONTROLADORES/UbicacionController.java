...
import METODOS_CONTROLADORES.util.JsfUtil;
import METODOS_CONTROLADORES.util.JsfUtil.PersistAction;
...
public class UbicacionController implements Serializable {
    ...
    @EJB
    private METODOS_CONTROLADORES.UbicacionFacade ejbFacade;
